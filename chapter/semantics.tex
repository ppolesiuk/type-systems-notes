...
When we associate evaluation contexts with stack frames, these two variants
correspond to two different orderings. In the inside-out style, the root contains
first operation that will be applied to the value produced by $\square$. \\
...
\begin{figure}[h]
  ...
  \begin{subfigure}{0.30\textwidth}
    \includegraphics[width=0.6\linewidth]{images/outside-in.jpg}
    \caption{Outside-in context}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.30\textwidth}
    \includegraphics[width=0.6\linewidth]{images/inside-out.jpg}
