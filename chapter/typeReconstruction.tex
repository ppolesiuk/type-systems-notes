...
\begin{mathpar}
	\inferrule{(x : \forall_{\alpha_1\ldots\alpha_n}.\tau) \in \Gamma}
	{\Gamma\vdash x \Uparrow
	\tau\{\sfrac{\UVarX_1}{\alpha_1},\ldots,\sfrac{\UVarX_n}{\alpha_n}\} /
	\emptyset}
  ...
  \inferrule{\Gamma\vdash e_1 \Uparrow \tau / \theta \\
            \theta'^*\Gamma,x:\forall_{\alpha_1\ldots\alpha_n}.
            \tau\{\sfrac{\alpha_1}{\UVarX_1},\ldots,\sfrac{\alpha_n}{\UVarX_n}\}
            \vdash e_2 \Uparrow \tau' / \theta'}
            {\Gamma\vdash let\;x\;=\;e_1\;in\;e_2 \Uparrow \tau' / \theta' \circ \theta}

            \text{where }\{\UVarX_1,\ldots,\UVarX_n\}\in \text{fuv}(\tau)\setminus\text{fuv}(\theta^*\Gamma)
